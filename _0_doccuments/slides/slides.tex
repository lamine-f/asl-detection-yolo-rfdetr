...
\begin{frame}{Application Gradio — 4 onglets}
  \begin{columns}[T,onlytextwidth]
    ...
    \medskip
    \footnotesize
    Déploiement : \textbf{Docker} + \textbf{Caddy} + Let's Encrypt.\\
    \textcolor{espblue}{\url{asl-detection-yolo-rfdetr.duckdns.org}}

    \column{.55\textwidth}
    \centering
    \includegraphics[width=\linewidth]{fig_demo_screenshot.png}\\[2pt]
    {\tiny Cas hors distribution : RF-DETR détecte le « Z » (0.92), YOLO échoue.}
  \end{columns}
\end{frame}
