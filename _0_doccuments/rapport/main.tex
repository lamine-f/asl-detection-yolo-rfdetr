...
\midrule
mAP@0.5             & 0.904 & \TODO{XX.X} \\
mAP@0.5:0.95        & 0.876 & \TODO{XX.X} \\
Précision           & 0.879 & \TODO{XX.X} \\
Rappel              & 0.755 & \TODO{XX.X} \\
F1-score            & 0.812 & \TODO{XX.X} \\
Latence (ms/img)    & 23.5  & \TODO{X.X}  \\
FPS (T4 GPU)        & 42.6  & \TODO{XX}   \\
Taille (\si{MB})    & 5.21  & \TODO{XX.X} \\
\bottomrule
\end{tabular}
\end{table}
